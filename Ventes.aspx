...
<script runat="server">
    ...
    Dim myConnection As SqlConnection 
        ...
        Sub RemplirListeMois()
            ...
            Dim list As New ArrayList
        list.Add("2014 - Janvier")
        list.Add("2014 - Février")
        list.Add("2014 - Mars")
        list.Add("2014 - Avril")
        list.Add("2014 - Mai")
        list.Add("2014 - Juin")
        list.Add("2014 - Juillet")
        list.Add("2014 - Août")
        list.Add("2014 - Septembre")
        list.Add("2014 - Octobre")
        list.Add("2014 - Novembre")
        list.Add("2014 - Décembre")
    ...
    Function GetDataSource_Familles(mois As Integer) As DataView
        ...
        Dim param As String = String.Format("2014{0:D2}", mois)
        myConnection = CType(Session("myConnection"), SqlConnection)
