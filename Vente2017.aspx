...
<script runat="server">
    ...
    Dim myConnection As SqlConnection 
        ...
        Sub RemplirListeMois()
            ...
            Dim list As New ArrayList
        list.Add("2017 - Janvier")
        list.Add("2017 - Février")
        list.Add("2017 - Mars")
        list.Add("2017 - Avril")
        list.Add("2017 - Mai")
        list.Add("2017 - Juin")
        list.Add("2017 - Juillet")
        list.Add("2017 - Août")
        list.Add("2017 - Septembre")
        list.Add("2017 - Octobre")
        list.Add("2017 - Novembre")
        list.Add("2017 - Décembre")
    ...
    Function GetDataSource_Familles(mois As Integer) As DataView
        ...
        Dim param As String = String.Format("2017{0:D2}", mois)
        myConnection = CType(Session("myConnection"), SqlConnection)
