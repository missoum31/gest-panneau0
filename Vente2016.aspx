...
<script runat="server">
    ...
    Dim myConnection As SqlConnection 
        ...
        Sub RemplirListeMois()
            ...
            Dim list As New ArrayList
        list.Add("2016 - Janvier")
        list.Add("2016 - Février")
        list.Add("2016 - Mars")
        list.Add("2016 - Avril")
        list.Add("2016 - Mai")
        list.Add("2016 - Juin")
        list.Add("2016 - Juillet")
        list.Add("2016 - Août")
        list.Add("2016 - Septembre")
        list.Add("2016 - Octobre")
        list.Add("2016 - Novembre")
        list.Add("2016 - Décembre")
    ...
    Function GetDataSource_Familles(mois As Integer) As DataView
        ...
        Dim param As String = String.Format("2016{0:D2}", mois)
        myConnection = CType(Session("myConnection"), SqlConnection)
